...
client.on('message', msg => {
  ...
  else if (msg.author.id === '637235315542720512') {
    msg.reply(`Jai aucune peine ca va te niquer ta mere ainsi que <@{titouancv}>`)
  }
  else if (msg.author.id === '351803191912038400') {
    msg.reply('ALETERTEEEEEE  AUUUUU VIOLLLLLLL')
  }
  else if (msg.author.id === '167625198227554304') {
    msg.reply('Louna ENLEVE TON DOIGT JAIME TROPPPPP BORDELLLLLLLL')
  }
});
